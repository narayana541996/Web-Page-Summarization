...
const extract_search_features = function () {
    ...
    // Check for button in children
        ...
        searchCandidateList.push(item, has_inner_text=has_inner_text, has_search_inner_text=has_search_inner_text, num_search=num_search, has_button=has_button, has_search_attr=has_search_attr)
    }   
}
